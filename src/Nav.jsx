...
function Nav(){
    ...
    if(navState === true){
        return[
            <div key={idsItems[0].id} className="nav">
                ...
                <div className="nav-mobile">
                    <ul className="nav-mobile__container">
                        ...
                        <li key={idsItems[1].id} className="nav-mobile__items">Home</li>
                        <Categories idKey={idsItems[3].id}/>
                        <li key={idsItems[2].id} className="nav-mobile__items">lala</li>
                    </ul>
                </div>
            </div>,
        ]
        ...
        return(
            <div key={idsItems[3].id} className="nav">
                <ul  className="nav-container">
                    <svg 
                    onClick={
                        () => setNavState(prevNavState => !prevNavState)
